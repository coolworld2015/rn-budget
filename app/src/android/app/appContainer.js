...
class OtherTab extends Component {
    ...
    renderScene(route, navigator) {
        switch (route.index) {
            case 0:
                return <Other routes={this.routes} onLogOut={this.onLogOut.bind(this)} navigator={navigator}/>;
                break;
            ...
            case 10:
                ...
                break;
            case 11:
                return <ProjectDetails data={route.data} routes={this.routes} navigator={navigator}/>;
                break;
            case 12:
            ...
            case 20:
                ...
                break;
            case 21:
                return <ResourceDetails data={route.data} routes={this.routes} navigator={navigator}/>;
                break;
            case 22:
                return <ResourceAdd data={route.data} routes={this.routes} navigator={navigator}/>;
                break;

            case 30:
                return <Departments routes={this.routes} navigator={navigator}/>;
                break;
            case 31:
                return <DepartmentDetails data={route.data} routes={this.routes} navigator={navigator}/>;
                break;
            case 32:
            ...
            case 40:
                ...
                break;
            case 41:
                return <EmployeeDetails data={route.data} routes={this.routes} navigator={navigator}/>;
                break;
            case 42:
    ...
    renderScene(route, navigator) {
        switch (route.index) {
            ...
            case 1:
                ...
                break;
            case 2:
                return <OutputAdd data={route.data} routes={this.routes} navigator={navigator}/>;
                break;
        }
    }
    ...
    renderScene(route, navigator) {
        switch (route.index) {
            ...
            case 1:
                ...
                break;
            case 2:
                return <InputAdd data={route.data} routes={this.routes} navigator={navigator}/>;
                break;
        }
    }
...
class AssetsTab extends Component {
    ...
    renderScene(route, navigator) {
        switch (route.index) {
            case 0:
                return <Assets routes={this.routes} navigator={navigator}/>;
                break;
        }
    }
